...
Index_mphf::Index_mphf(size_t k_size, size_t m_size, size_t log2_super_bucket,
    size_t small_b_size, size_t multiplier_bucket):
  k(k_size),
  m(m_size),
  log2_super_bucket(log2_super_bucket),
